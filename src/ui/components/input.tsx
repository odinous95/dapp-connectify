  ...
  return (
    <div className="w-full relative my-4">
      <input
        ...
        disabled={disabled}
        type={type}
        className="peer relative z-10 w-full p-4 pl-4 font-light bg-transparent border-2 border-gray-300 dark:border-gray-600 rounded-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed text-gray-900 dark:text-gray-100"
      />
      <label
